package com.mm.cache.policies;


import com.mm.algorithms.DoublyLinkedList;
import com.mm.algorithms.DoublyLinkedListNode;
...
public class LRUEvictionPolicy<Key> implements EvictionPolicy<Key>{
    ...
    /*
        This will tell us which key we want to remove
     */
    @Override
    public Key evictKey() {
